...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  ...
  /*  std::pair<pcl::PointCloud<pcl::PointXYZ>::Ptr, pcl::PointCloud<pcl::PointXYZ>::Ptr> segmentCloud1 = pointProcessor.SegmentPlane1(inputCloud, 100, 0.2);
...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
 ...
 // renderPointCloud(viewer,inputCloud,"inputCloud");
  ...
  // Experiment with the ? values and find what works best
   filterCloud = pointProcessorI->FilterCloud(inputCloud, 0.1 , Eigen::Vector4f (1, 15, 1, 1), Eigen::Vector4f (25, 15, 1, 1));
